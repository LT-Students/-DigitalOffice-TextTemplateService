...
using LT.DigitalOffice.TextTemplateService.Validation.Validators.ParseEntity.Interfaces;

namespace LT.DigitalOffice.TextTemplateService.Business.Validators.ParseEntity
{
